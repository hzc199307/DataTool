...
class PrecisionRecall:
	...
	def print_precision_recall(pr_tuple_list):
		for pr_tuple in pr_tuple_list:
			...
			print "1-end\t" + '%-10s'%('%-.5s'%str(float(fenzi_sum_1_end)/precision_fenmu_sum_1_end)) + "\t" + '%-.5s'%str(float(fenzi_sum_1_end)/recall_fenmu_sum_1_end) + "\t" + '%7s'%str(fenzi_sum_1_end) + "\t" + '%15s'%str(precision_fenmu_sum_1_end) + "\t" + '%12s'%str(recall_fenmu_sum_1_end)
			print ""
